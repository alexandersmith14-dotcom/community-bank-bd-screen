...
const SIGNALS = [
  ...
  ["near_fdicia_1b","Near $1B (FDICIA audit)","snapshot"],
  ["near_fdicia_5b","Near $5B (FDICIA ICFR)","snapshot"],
...
const SIGSERVICE = {
  ...
  near_fdicia_5b:      "FDICIA Part 363 ICFR management assessment + auditor attestation (crossing $5B, 2026 threshold)",
...
const DESC = {
  ...
  near_10b_threshold: "Assets between $8B and $10B — approaching the $10B tier (CFPB supervision, Durbin, DFAST).",
  near_fdicia_1b: "Assets ~$850M–$1.15B — crossing the $1B FDICIA Part 363 annual-audit + audit-committee trigger (raised from $500M, effective 2026).",
  near_fdicia_5b: "Assets ~$4.25B–$5.5B — crossing the $5B FDICIA Part 363 ICFR attestation trigger (raised from $1B, effective 2026).",
