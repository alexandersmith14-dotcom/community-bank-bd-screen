...
SIGLAB = {
    ...
    "consent_order": "Formal enforcement order (FDIC/OCC/Fed/NCUA)",
}
SIGSVC = {
    ...
    "consent_order": "BSA/AML & Sanctions remediation, Internal Audit, independent testing (confirmed FDIC/OCC/Fed/NCUA enforcement order)",
}
LD_TITLES = {
